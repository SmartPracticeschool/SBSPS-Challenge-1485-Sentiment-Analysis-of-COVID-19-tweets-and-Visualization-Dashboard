...
def predict():
  class TwitterClient(object): 
    def __init__(self): 
        ...
        try: 
            ...
            auth = OAuthHandler('vxwf1bsM9pm4S6xbiiJSvNdpA', '70x93d69DNKGEvafNKT4wMa8jxg2WFN5nZwrrI8KDg8iOjmJVL') 
            # set access token and secret 
            auth.set_access_token('1272076773115588609-EldNoxd0ZhNIFhxb5loFSfVy5puonE', 'AmxV5ZV6048Hsxvq2CQpG1q0oGfNisU5G7kX3BVquSZwj') 
  ...
  x = d.iloc[:,-2].values
  tv = TfidfVectorizer(max_df=0.90, min_df=2, stop_words='english',ngram_range=(1, 2),max_features=13220)
